...
<section style="background-image: url('{{ asset('images/imagenesInalec/Inalec 2012 1920x1080.jpg') }}'); background-attachment: fixed; background-size: cover;" >

    <!-- Sección para el h1 -->
    <div class="w-full min-h-screen flex flex-col items-center justify-center bg-cover bg-center text-white font-bold px-4">
    ...
    <div class="w-full bg-cover bg-center text-white font-bold px-4 py-20">
        ...
        <div class="max-w-4xl text-xl text-justify mx-auto space-y-10">
            ...
            <div class="flex flex-col md:flex-row-reverse items-center gap-6" data-aos="fade-left" data-aos-delay="200">
                <img class="w-full md:w-1/2 h-48 object-cover rounded shadow-lg"
                     src="{{ asset('images/imagenesproyectos/revamping-planta-cepsa.jpg') }}" alt="Revamp planta cepsa">
                <p class="text-white text-justify text-base md:text-lg max-w-lg px-2">
                    holaa holaa holaa
