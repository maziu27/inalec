...
@section('content')
    <h1 class="text-6xl font-bold text-center mb-8 mt-20 text-[rgb(0,176,243)]">Nuestros proyectos</h1>
    ...
    <!-- Enlaces con imagen y mismo ancho -->
    <div class="flex justify-center gap-10 mb-16 flex-wrap">
        ...
        {{-- <a href="{{ route('sostenibilidad') }}" class="group w-56 hover:scale-105 transition-transform text-center">
            <div class="bg-white shadow-lg rounded-lg p-4">
                <img src="{{ asset('images/imagenesproyectos/navalacruz-elegancia.jpg') }}" alt="Sostenibilidad" class="w-full h-36 object-contain mx-auto mb-4">
                <p class="font-semibold text-gray-700 group-hover:text-green-600 transition">Sostenibilidad</p>
            </div>
        </a> --}}
